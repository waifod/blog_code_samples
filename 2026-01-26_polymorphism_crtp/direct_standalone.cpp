// Standalone version of bench_direct to examine assembly without benchmark framework
//
// Build:
//   clang++ -O2 -std=c++20 -march=native -o direct_standalone direct_standalone.cpp
//
// Assembly:
//   clang++ -O2 -std=c++20 -march=native -S direct_standalone.cpp -o direct_standalone.s
